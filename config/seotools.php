...
return [
    ...
    'meta' => [
        ...
        'defaults'       => [
            ...
            'titleBefore'  => true, // Put defaults.title before page title, like 'Gobernación del Beni - Título de página'
            ...
            'separator'    => ' - ',
            'keywords'     => ['Beni', 'Bolivia', 'Gobernación', 'Trinidad', 'Gobierno departamental', 'Servicios públicos'],
