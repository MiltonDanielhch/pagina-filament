...
<article class="container mx-auto px-4 py-12 max-w-2xl">
    ...
    <form method="POST" action="{{ route('contact.send') }}" class="space-y-6" id="contact-form" novalidate>
        ...
        <button type="submit"
                class="w-full bg-official hover:bg-official-dark text-white font-bold py-3 px-6 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
            Enviar mensaje
        </button>
    </form>
</article>
