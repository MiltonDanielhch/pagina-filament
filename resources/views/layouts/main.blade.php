            ...
            <div class="container mx-auto px-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="https://twitter.com/GAD_Beni" target="_blank" class="hover:text-amber-200 transition">
                        <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H6.828l7.581-8.615L4.25 2.25h8.088l5.825 7.326L18.244 2.25zM2.25 22.5h5.5l.75-8.5H2.75v8.5zm15.5 0h2v-8h-2v8z"/></svg>
                    </a>
